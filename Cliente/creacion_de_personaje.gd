...
Conecta las señales de los botones, gestiona el botón de ayuda y establece la conexión WebSocket.
"""
func _ready():
	...
	# Integración del botón de ayuda con la URL de soporte
...
"""
_process
Mantiene el socket activo y gestiona las respuestas del servidor.
"""
func _process(delta):
	socket.poll()
